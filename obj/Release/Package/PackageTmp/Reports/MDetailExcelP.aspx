<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="MDetailExcelP.aspx.cs" Inherits="WMS.Reports.MDetailExcelP" %>
    ...
    <div class="report-container">
         <div class="report-filter">
             ...
             <div class="button-divDate">
                 <span></span><input id="dateTo" type="date" runat="server" style="height:30px;" />
                 <asp:Button ID="Button1" Visible="false" CssClass="btn btn-primary" runat="server" Text="Export To Excel"  Width="180px" OnClick="Button1_Click"/>
             </div>
            ...
            <div class="button-div"><asp:Button ID="btnEmployeeGrid" CssClass="btn btn-primary" runat="server" Text="Select Employee" onclick="btnEmployeeGrid_Click" Width="180px"/>
             ...
             <div class="button-div"><asp:Button ID="btnCompanyGrid" CssClass="btn btn-primary" runat="server" Text="Select Company" onclick="btnCompanyGrid_Click" Width="180px"/>
                <div><asp:Label ID="lbCompCount" runat="server" Text="Selected Company: 0" Font-Bold="False" Font-Italic="True" Font-Size="10pt" ForeColor="#F9F9F9"></asp:Label></div>
            </div>
         ...
         <div class="report-viewer-container" style="margin: 0 auto;">
             ...
             <%-- Company Grid --%>
             <div runat="server" id="DivGridComapny" style="margin: 20px;">
                 <div style="font-size: 15px;margin: 10px;font-weight: bold;">Press Ctrl+F to Find a Company </div>
             <asp:GridView ID="grid_Company" runat="server" AutoGenerateColumns="False" DataKeyNames="CompID">
                 <Columns>
                     <asp:TemplateField>
                            <ItemTemplate>
                                <asp:CheckBox ID="chkCtrlCompany" runat="server" oncheckedchanged="chkCtrlCompany_CheckedChanged"/>
                            </ItemTemplate>
                        </asp:TemplateField>
                     <asp:BoundField DataField="CompID" HeaderText="ID" InsertVisible="False" ReadOnly="True" SortExpression="CompID" />
  ...
  <%-- Section Grid --%>
             ...
             <div>
                 <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt">
                     <LocalReport ReportPath="Reports\RDLC\MRDetailExcelP.rdlc">
                         <DataSources>
                             <rsweb:ReportDataSource DataSourceId="ObjectDataSource8" Name="DataSet1" />
                         </DataSources>
                     </LocalReport>
                 </rsweb:ReportViewer>
                 <asp:ObjectDataSource ID="ObjectDataSource8" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="GetData" TypeName="WMS.Models.TASReportDataSetTableAdapters.ViewMonthlyDataPerTableAdapter"></asp:ObjectDataSource>
