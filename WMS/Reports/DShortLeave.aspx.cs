...
{
    public partial class DShortLeave : System.Web.UI.Page
    {
        string PathString = "";
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                DataTable dt = qb.GetValuesfromDB("select * from ViewSLData " + query);
                List<ViewSLData> _View = dt.ToList<ViewSLData>();
        ...
        protected void btnGenerateReport_Click(object sender, EventArgs e)
        {
            ...
            DataTable dt = qb.GetValuesfromDB("select * from ViewSLData " + query);
            List<ViewSLData> _ViewList = dt.ToList<ViewSLData>();
        ...
        private void LoadReport(string path, List<ViewSLData> _Employee)
        {
            string DateToFor = "";
