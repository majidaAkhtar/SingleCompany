...
{
    public partial class DMissingAtt : System.Web.UI.Page
    {
        string PathString = "";
        ...
        protected void btnGenerateReport_Click(object sender, EventArgs e)
        {
            ...
            if (Option == "Any")
            {
                _ViewList = _ViewList.Where(aa => (aa.AttDate >= DateFrom.Date && aa.AttDate <= DateTo.Date) && ((aa.TimeIn == null && aa.TimeOut != null) || (aa.TimeIn != null && aa.TimeOut == null))).ToList();
            }
            if (Option == "IN")
            {
                _ViewList = _ViewList.Where(aa => (aa.AttDate >= DateFrom.Date && aa.AttDate <= DateTo.Date) && ((aa.TimeIn == null && aa.TimeOut != null))).ToList();
            }
        ...
        private void LoadReport(string path, List<ViewAttData> _Employee)
        {
            ...
            this.ReportViewer1.LocalReport.DisplayName = "Missing Attendance Report";
