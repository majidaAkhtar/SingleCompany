...
{
    public partial class DLeave : System.Web.UI.Page
    {
        string PathString = "";
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                LoadGridViews();
                RefreshLabels();
                DateTime date = DateTime.Today.Date.AddDays(-5);
        ...
        private void LoadReport(string path, List<ViewLeaveData> _Employee)
        {
            string DateToFor = "";
            ...
            string _Header = "Leaves Report";
            this.ReportViewer1.LocalReport.DisplayName = "Leave Application Report";
            ReportViewer1.ProcessingMode = ProcessingMode.Local;
            ReportViewer1.LocalReport.ReportPath = Server.MapPath(path);
            System.Security.PermissionSet sec = new System.Security.PermissionSet(System.Security.Permissions.PermissionState.Unrestricted);
            ReportViewer1.LocalReport.SetBasePermissionsForSandboxAppDomain(sec);
            IEnumerable<ViewLeaveData> ie;
