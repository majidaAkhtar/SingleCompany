...
{
    public partial class MSheetC : System.Web.UI.Page
    {
        string PathString = "";
        ...
        private void LoadReport(string path, List<ViewMonthlyData> _Employee)
        {
            string _Header = "Monthly Sheet Contactual Employees";
            this.ReportViewer1.LocalReport.DisplayName = "Monthly Sheet Report";
